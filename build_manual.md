...
| 파일명 | 대상 플랫폼 |
|--------|-------------|
| `aimi-linux-aarch64` | Linux ARM64 |
| `aimi-linux-x86_64` | Linux x86_64 |
| `aimi-macos-aarch64` | macOS Apple Silicon (M1/M2/M3/M4) |
| `aimi-macos-x86_64` | macOS Intel |
