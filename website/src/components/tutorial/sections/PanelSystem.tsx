      ...
      {lang === 'ko' ? (
        <>
          <p className="text-zinc-400 mb-6 leading-relaxed">
            ...
            aimi에서는 화면을 여러 개의 "패널"로 나눌 수 있습니다. 각 패널은 독립적인 파일 탐색기처럼
        ...
        <>
          <p className="text-zinc-400 mb-6 leading-relaxed">
            ...
            In aimi, you can split the screen into multiple "panels". Each panel works as an independent file browser,
