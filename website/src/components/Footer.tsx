      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="text-center md:text-left">
            <h3 className="text-xl font-bold gradient-text mb-1">aimi</h3>
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6">
            ...
            <a
              href="https://github.com/kstost/aimi/blob/main/LICENSE"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 text-zinc-400 hover:text-white transition-colors"
            >
        ...
        <div className="mt-8 pt-6 border-t border-zinc-800 text-center">
          <p className="text-zinc-500 text-sm">
            © 2026 <a href="https://aimi.cokac.com" className="text-accent-cyan hover:underline">cokac</a>. {t('All rights reserved.', 'All rights reserved.')}
          </p>
        </div>
      </div>
    </footer>
